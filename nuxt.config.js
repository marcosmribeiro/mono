...
module.exports = {
  ...
  */
  head: {
    ...
    title: brand.mono.name,
    meta: [
      { charset: 'utf-8' },
      { name: 'viewport', content: 'width=device-width, initial-scale=1' },
      { name: 'description', content: brand.mono.desc },
      { name: 'msapplication-TileColor', content: '#FFFFFF' },
      { name: 'msapplication-TileImage', content: '/favicons/ms-icon-144x144.png' },
      // PWA primary color
      { name: 'theme-color', content: theme.primary},
      // Facebook
      { property: 'author', content: 'Mono - No Aware' },
      { property: 'og:site_name', content: 'restaurantemono.com.br' },
      { property: 'og:locale', content: 'pt_BR' },
      { property: 'og:type', content: 'website' },
      // Twitter
      { property: 'twitter:site', content: 'restaurantemono.com.br' },
      { property: 'twitter:domain', content: 'restaurantemono.com.br' },
      { property: 'twitter:creator', content: 'marcos ribeiro' },
      { property: 'twitter:card', content: 'summary' },
      { property: 'twitter:image:src', content: '/images/logo.png' },
      { property: 'og:url', content: brand.mono.url },
      { property: 'og:title', content: brand.mono.projectName },
      { property: 'og:description', content: brand.mono.desc },
      { name: 'twitter:site', content: brand.mono.url },
      { name: 'twitter:card', content: 'summary_large_image' },
      { name: 'twitter:image', content: brand.mono.img },
      { property: 'og:image', content: brand.mono.img },
